...
CREATE TABLE `check_project` (
  ...
  PRIMARY KEY (`check_project_id`,`check_project_doctor_id`,`check_project_date`,`check_project_result`,`check_project_patient_id`),
  KEY `fk_check_doctor_id` (`check_project_doctor_id`),
  KEY `fk_check_patient_id` (`check_project_patient_id`),
  CONSTRAINT `fk_check_doctor_id` FOREIGN KEY (`check_project_doctor_id`) REFERENCES `staff_info` (`staff_info_id`),
  CONSTRAINT `fk_check_patient_id` FOREIGN KEY (`check_project_patient_id`) REFERENCES `patient` (`patient_id`)
...
CREATE TABLE `depart` (
  ...
  KEY `depart_manager_staff_id` (`manager_staff_id`),
  KEY `depart_vice_manager` (`vice_manager_staff_id`),
  CONSTRAINT `depart_manager_staff_id` FOREIGN KEY (`manager_staff_id`) REFERENCES `staff_info` (`staff_info_id`),
  CONSTRAINT `depart_vice_manager` FOREIGN KEY (`vice_manager_staff_id`) REFERENCES `staff_info` (`staff_info_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `drug_apply` (
  ...
  KEY `fk_drug_apply_job_unit` (`drug_apply_job_unit`),
  KEY `fk_drug_apply_drug_id` (`drug_apply_drug_id`),
  CONSTRAINT `fk_drug_apply_job_unit` FOREIGN KEY (`drug_apply_job_unit`) REFERENCES `job` (`job_id`),
  CONSTRAINT `fk_drug_apply_drug_id` FOREIGN KEY (`drug_apply_drug_id`) REFERENCES `material` (`material_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `expected_purchase` (
  ...
  KEY `fk_buyer_staff_id` (`buyer_staff_id`),
  KEY `fk_examine_staff_id` (`examine_staff_id`),
  KEY `fk_supplier_id` (`supplier_id`),
  CONSTRAINT `fk_examine_staff_id` FOREIGN KEY (`examine_staff_id`) REFERENCES `staff_info` (`staff_info_id`),
  CONSTRAINT `fk_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `supplier` (`supplier_id`),
  CONSTRAINT `fk_buyer_staff_id` FOREIGN KEY (`buyer_staff_id`) REFERENCES `staff_info` (`staff_info_id`),
  CONSTRAINT `fk_expected_purchase_id` FOREIGN KEY (`expected_purchase_id`) REFERENCES `material` (`material_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `hospital` (
  ...
  KEY `fk_hospital_staff_info_id` (`staff_info_id`),
  KEY `fk_hospital_patient_id` (`hospital_patient_id`),
  KEY `fk_hospital_bed_id` (`hospital_bed_id`),
  CONSTRAINT `fk_hospital_bed_id` FOREIGN KEY (`hospital_bed_id`) REFERENCES `sickbed` (`sickbed_id`),
  CONSTRAINT `fk_hospital_patient_id` FOREIGN KEY (`hospital_patient_id`) REFERENCES `patient` (`patient_id`),
  CONSTRAINT `fk_hospital_staff_info_id` FOREIGN KEY (`staff_info_id`) REFERENCES `staff_info` (`staff_info_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `hospital_apply` (
  ...
  KEY `fk_applyPatientID` (`hospital_apply_patient_id`),
  KEY `fk_applyJobId` (`hospital_apply_job_id`),
  KEY `fk_staffInfo_id` (`staff_info_id`),
  CONSTRAINT `fk_staffInfo_id` FOREIGN KEY (`staff_info_id`) REFERENCES `staff_info` (`staff_info_id`),
  CONSTRAINT `fk_applyJobId` FOREIGN KEY (`hospital_apply_job_id`) REFERENCES `job` (`job_id`),
  CONSTRAINT `fk_applyPatientID` FOREIGN KEY (`hospital_apply_patient_id`) REFERENCES `patient` (`patient_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `hospital_fee` (
  ...
  KEY `fk_hospital_fee_collect_fees_id` (`collect_fees_id`),
  KEY `fk_fee_patient_id` (`hospital_patient_id`),
  KEY `fk_fee_doctor_id` (`doctor_id`),
  CONSTRAINT `fk_hospital_fee_collect_fees_id` FOREIGN KEY (`collect_fees_id`) REFERENCES `staff_info` (`staff_info_id`),
  CONSTRAINT `fk_fee_patient_id` FOREIGN KEY (`hospital_patient_id`) REFERENCES `patient` (`patient_id`),
  CONSTRAINT `fk_fee_doctor_id` FOREIGN KEY (`doctor_id`) REFERENCES `staff_info` (`staff_info_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `hospital_fee_detail` (
  ...
  KEY `fk_detail_collect_fees_id` (`collect_fees_id`),
  CONSTRAINT `fk_detail_collect_fees_id` FOREIGN KEY (`collect_fees_id`) REFERENCES `staff_info` (`staff_info_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `material_depot` (
  ...
  KEY `fk_material_depot_material_id` (`material_id`),
  CONSTRAINT `fk_material_depot_material_id` FOREIGN KEY (`material_id`) REFERENCES `material` (`material_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `medical_record` (
  ...
  KEY `fk_record_patientID` (`medical_record_patient_id`),
  KEY `fk_record_doctorId` (`medical_record_doctor_id`),
  CONSTRAINT `fk_record_patientID` FOREIGN KEY (`medical_record_patient_id`) REFERENCES `patient` (`patient_id`),
  CONSTRAINT `fk_record_doctorId` FOREIGN KEY (`medical_record_doctor_id`) REFERENCES `staff_info` (`staff_info_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `prescription` (
  ...
  KEY `fk_prescription_doctorId` (`prescription_doctor_id`),
  KEY `fk_prescription_patientId` (`prescription_patient_id`),
  KEY `fk_prescription_collect_feesID` (`collect_fees_id`),
  CONSTRAINT `fk_prescription_doctorId` FOREIGN KEY (`prescription_doctor_id`) REFERENCES `staff_info` (`staff_info_id`),
  CONSTRAINT `fk_prescription_patientId` FOREIGN KEY (`prescription_patient_id`) REFERENCES `patient` (`patient_id`),
  CONSTRAINT `fk_prescription_collect_feesID` FOREIGN KEY (`collect_fees_id`) REFERENCES `staff_info` (`staff_info_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `prescription_detail` (
  ...
  KEY `fk_detail_material_id` (`drug_apply_id`),
  CONSTRAINT `fk_detail_prescription` FOREIGN KEY (`prescription_id`) REFERENCES `prescription` (`prescription_id`),
  CONSTRAINT `fk_detail_material_id` FOREIGN KEY (`drug_apply_id`) REFERENCES `material` (`material_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `register` (
  ...
  KEY `fk_patientId` (`register_patient_id`),
  KEY `fk_schedulingDateId` (`scheduling_date_id`),
  KEY `fk_collectFeesId` (`collect_fees_id`),
  CONSTRAINT `fk_schedulingDateId` FOREIGN KEY (`scheduling_date_id`) REFERENCES `scheduling_date` (`scheduling_date_id`),
  CONSTRAINT `fk_collectFeesId` FOREIGN KEY (`collect_fees_id`) REFERENCES `staff_info` (`staff_info_id`),
  CONSTRAINT `fk_patientId` FOREIGN KEY (`register_patient_id`) REFERENCES `patient` (`patient_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `scheduling_date` (
  ...
  KEY `fk_staffInfoId` (`staff_info_id`),
  CONSTRAINT `fk_staffInfoId` FOREIGN KEY (`staff_info_id`) REFERENCES `staff_info` (`staff_info_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `sickbed` (
  ...
  KEY `fk_sickbed_ward_id` (`ward_id`),
  CONSTRAINT `fk_sickbed_ward_id` FOREIGN KEY (`ward_id`) REFERENCES `ward` (`ward_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `sickbed_maintain` (
  ...
  KEY `fk_maintain_sickbed_id` (`sickbed_id`),
  CONSTRAINT `fk_maintain_sickbed_id` FOREIGN KEY (`sickbed_id`) REFERENCES `sickbed` (`sickbed_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `staff_info` (
  ...
  KEY `fk_staff_info_job_id` (`staff_info_job_id`),
  CONSTRAINT `fk_staff_info_job_id` FOREIGN KEY (`staff_info_job_id`) REFERENCES `job` (`job_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `storing` (
  ...
  KEY `fk_storing_detail_id` (`storing_detail_id`),
  KEY `fk_storing_staff_id` (`storing_staff_id`),
  KEY `fk_storing_detail_supplier_id` (`storing_detail_supplier_id`),
  CONSTRAINT `fk_storing_detail_id` FOREIGN KEY (`storing_detail_id`) REFERENCES `material` (`material_id`),
  CONSTRAINT `fk_storing_staff_id` FOREIGN KEY (`storing_staff_id`) REFERENCES `staff_info` (`staff_info_id`),
  CONSTRAINT `fk_storing_detail_supplier_id` FOREIGN KEY (`storing_detail_supplier_id`) REFERENCES `supplier` (`supplier_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `treatment_project` (
  ...
  KEY `fk_treatment_doctor_id` (`doctor_id`),
  KEY `fk_treatment_patient_id` (`treatment_project_patient_id`),
  CONSTRAINT `fk_treatment_doctor_id` FOREIGN KEY (`doctor_id`) REFERENCES `staff_info` (`staff_info_id`),
  CONSTRAINT `fk_treatment_patient_id` FOREIGN KEY (`treatment_project_patient_id`) REFERENCES `patient` (`patient_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `user_authority` (
  ...
  KEY `fk_authority_level` (`user_authority_level`),
  KEY `fk_user_authority_staff_id` (`user_authority_staff_id`),
  CONSTRAINT `fk_user_authority_staff_id` FOREIGN KEY (`user_authority_staff_id`) REFERENCES `staff_info` (`staff_info_id`),
  CONSTRAINT `fk_authority_level` FOREIGN KEY (`user_authority_level`) REFERENCES `authority_level` (`authority_level_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
